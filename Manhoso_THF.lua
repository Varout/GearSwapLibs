...
function init_gear_sets()
    ...
    HercFeet.TP = { name="Herculean Boots", augments={'"Triple Atk."+4','DEX+8','Accuracy+1',}}
    ...
    HercLegs.TH = { name="Herculean Trousers", augments={'Attack+16','Accuracy+2','"Treasure Hunter"+1','Accuracy+18 Attack+18',}}

    Toutatis = {}
    Toutatis.STP = { name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Store TP"+10','Damage taken-5%',}}
    Toutatis.WSD = { name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}} 

    sets.TreasureHunter = {  ammo="Perfect Lucky Egg", head="White Rarab Cap +1", hands="Plunderer's Armlets +1", feet="Skulker's Poulaines +1", waist="Chaac Belt", legs=HercLegs.TH }
    ...
    sets.precast.JA['Despoil'] = {feet="Raider's Poulaines +2",ammo="Barathrum"}
    ...
    sets.precast.FC = {
        ammo="Sapience Orb", --2
        head={ name="Herculean Helm", augments={'Mag. Acc.+20','"Fast Cast"+6','STR+2',}}, --13
		...
		ring2="Prolix Ring", --2
		waist="Sailfi Belt +1",
        legs={ name="Herculean Trousers", augments={'"Mag.Atk.Bns."+10','"Fast Cast"+6','AGI+4',}}, --6
		feet={ name="Herculean Boots", augments={'DEX+7','"Mag.Atk.Bns."+9','"Fast Cast"+7','Accuracy+5 Attack+5','Mag. Acc.+11 "Mag.Atk.Bns."+11',}}, --7
    }
