...
--  --------------------
    ...
    sets.midcast['BarElement'] = set_combine(sets.midcast['Enhancing Magic'], {
        main       = "Beneficus",                   --  Enhancing Magic +15, Enhanced Barpsells
        sub        = "Ammurapi Shield",             --  Enhancing magic duration +10%
        head       = "Ebers Cap +1",                --  Set: Occationally negates damage with correct barpsell
        body       = "Ebers Bliaut +1",             --  Set: Occationally negates damage with correct barpsell
...
function job_post_midcast(spell, action, spellMap, eventArgs)
    ...
    if (spell.action_type == 'Magic' and spell.skill ~= 'Enhancing Magic') or spell.name == 'Erase' then
        ...
        elseif spell.type == "Trust" then
            equipSet = sets.Trust
        elseif spellMap == "Barspell" then
            windower.add_to_chat(20, "Barspell")
        end
